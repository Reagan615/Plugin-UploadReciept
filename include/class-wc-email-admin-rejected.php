...
class WC_peproDev_RejectedReceipt_Admin extends WC_Email {
    /**
    ...
    public function __construct() {
        ...
        $this->title          = __('Rejected Receipt to Admin', 'receipt-upload');
        $this->description    = __('An email sent to the Admin when a receipt is rejected.', 'receipt-upload');
