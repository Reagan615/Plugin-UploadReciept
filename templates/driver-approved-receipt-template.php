<?php
/**
 * Customer Approved Receipt
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/customer-approved-receipt-template.php
 *
...
# @Last modified time: 2022/08/15 16:59:41

if ( ! defined( 'ABSPATH' ) ) {exit;}
$email_heading = 'Receipt Approved';
$sent_to_admin = false; 
